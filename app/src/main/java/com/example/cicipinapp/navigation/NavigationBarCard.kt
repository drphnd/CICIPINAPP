...
fun NavigationGraph(navController: NavHostController, modifier: Modifier = Modifier) {
    NavHost(
        ...
        composable("Restaurant") { RestaurantView(navController = navController) }
        composable("Review") { ReviewView(navController = navController) }
        composable("RestoRecommendation") { RestaurantView(navController = navController) }
        composable("Setting") { SettingView(navController = navController) }
        composable("ProfileSetting") { ProfileSettingView(navController = navController) }
    }
}
